...
export const JOBS_LIST_LONG = [
  ...
  },
  {
    ...
    description: [
      ...
      "Designed and developed three mobile apps: Range Analytics, Range Analytics for Branch, and Range Analytics Pro.",
      "Designed and implemented databases and back-end systems to support the aforementioned apps.",
      "Collaborated on various web and mobile projects within the company.",
      "Worked on Branch.io integration for native mobile applications (iOS and Android).",
    ],
    technologies: [
      "React",
      "React Native",
